...
function Series() {
  ...
  const fetchData = async () =>{
    let data = await fetch(`https://api.themoviedb.org/3/discover/tv?api_key=${process.env.REACT_APP_MV_KEY}&page=${page}&with_genres=${genreURL}`);
  ...
  return (
    <div>
      <h1 className="defTitle">Series</h1>
      <Genres
        media_type='tv'
